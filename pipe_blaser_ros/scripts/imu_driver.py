...
def str2msg(data):
    ...
    msg.angular_velocity.x = float(imu_values[5]) / 32768.0*IMU_GYO_SCALE / 180.0 * math.pi
    msg.angular_velocity.y = float(imu_values[6]) / 32768.0*IMU_GYO_SCALE / 180.0 * math.pi
    msg.angular_velocity.z = float(imu_values[7]) / 32768.0*IMU_GYO_SCALE / 180.0 * math.pi
